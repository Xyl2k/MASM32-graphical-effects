...
lpThreadParameter= dword ptr  4
		...
		mov hdcSrc,eax
		invoke CreateCompatibleBitmap,hDC,DCWidth,DCHeight
		mov cubeDC,eax
...
loc_404B67:
		...
		mov eax, 7
		call AttachTop
		invoke BitBlt,hDC,0,0,[ebp+8],[ebp+12],hdcSrc,0,0,SRCCOPY
		mov ecx, [esi]
		mov edx, 1
		xor eax, eax
		call InsertEdge
...
InsertEdge proc
		...
		invoke MoveToEx,hDC,dword_40B6F4[esi*8],dword_40B6F8[esi*8],0
		invoke LineTo,hDC,dword_40B6F4[edi*8],dword_40B6F8[edi*8]
